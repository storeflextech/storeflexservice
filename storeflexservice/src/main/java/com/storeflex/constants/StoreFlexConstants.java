package com.storeflex.constants;

import org.springframework.stereotype.Component;

@Component
public class StoreFlexConstants {

	public static final String CUST_GUEST = "GUEST";
	public static final String CUST_STORE_FLEX ="STORE_FLEX";
